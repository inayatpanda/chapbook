  ...
  presets: [
    {
      ...
      params: {
        ...
        cards: [
          { prompt: 'Searing a steak seals in the juices.', answer: 'Reality: searing browns the surface for flavour, but it does not seal anything in.', detail: 'The crust tastes better; the moisture loss is much the same either way.' },
          { prompt: 'Adding oil to the water stops pasta sticking together.', answer: 'Reality: the oil floats on top and mostly runs off; stirring is what keeps pasta apart.', detail: 'Save the oil for the sauce, where it actually helps.' },
          { prompt: 'Alcohol all cooks off once the dish reaches a simmer.', answer: 'Reality: some lingers — even after long cooking a small fraction can remain.', detail: 'How much depends on time, heat, and the size of the pan.' },
        ],
      },
    },
    {
      ...
      params: {
        ...
        scoreLabel: 'I got it',
        cards: [
          { prompt: 'Which is the largest planet in the Solar System?', answer: 'Jupiter.', detail: 'It is more than twice as massive as all the other planets combined.' },
          { prompt: 'What are the three primary colours of light?', answer: 'Red, green, and blue.', detail: 'Mixed at full strength they make white — the basis of every screen.' },
          { prompt: 'Which river is the longest in the world?', answer: 'It depends who you ask — the Nile and the Amazon both have a claim.', detail: 'Measuring a river is harder than it sounds; the source is rarely a single point.' },
        ],
      },
    },
  ],
