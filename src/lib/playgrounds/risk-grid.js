/* Family: risk grid (icon array / pictograph) — show "X in N" as a grid of dots
   with a slider to explore the rate. Good for making an everyday "how likely / how
   common" figure legible; works for any proportion. */
...
export default {
  ...
  paramsSchema: {
    ...
    properties: {
      ...
      unit: { type: 'string', title: 'Unit (e.g. people, items)', default: 'people' },
  ...
  presets: [
    {
      name: 'Left-handers in a room',
      params: { title: 'Roughly 1 in 10 people are left-handed', total: 100, affected: 10, columns: 10,
        unit: 'people', affectedColour: '#f472b6', interactive: true,
